...
<div class="coupon-form-checkout">
    ...
    <div class="woocommerce-form-coupon-toggle">
        ...
        <?php
            ...
            */
            ...
            wc_print_notice( apply_filters( 'woocommerce_checkout_coupon_message', esc_html__( 'Have a coupon?', 'suevafree' ) . ' <a href="#" role="button" aria-label="' . esc_attr__( 'Enter your coupon code', 'suevafree' ) . '" aria-controls="woocommerce-checkout-form-coupon" aria-expanded="false" class="showcoupon">' . esc_html__( 'Click here to enter your code', 'suevafree' ) . '</a>' ), 'notice' );
    ...
    <form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none" id="woocommerce-checkout-form-coupon">
        ...
        <p><?php esc_html_e( 'If you have a coupon code, please apply it below.', 'suevafree' ); ?></p>
